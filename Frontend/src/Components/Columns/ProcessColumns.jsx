...
import { fiberColorMap, processTagColors, StatusColorMap } from '../../Constants/Colors';
...
export const processLogColumns = [
  ...
  },
  {
    ...
    render: (inputMaterialColor) => (
      <Tag color={fiberColorMap[inputMaterialColor] || "default"}>{inputMaterialColor}</Tag>
    ),
  },
  {
    title: "Гаралтын жин",
...
export const processIOColumns = [
  ...
  },
  {
    ...
    align: "center",
    render: (color) => (
      <Tag color={fiberColorMap[color] || "default"}>{color}</Tag>
    ),
  },
  {
    title: 'Inventory ID',
...
export const inventoryColumns = (selectedFibers, setSelectedFibers) => [
  ...
  },
  {
    ...
    align: "center",
    render: (fiberColor) => (
      <Tag color={fiberColorMap[fiberColor] || "default"}>{fiberColor}</Tag>
    ),
  },
  {
    title: "Төрөл",
...
export const processDetailColumns = [
  {
    title: "Процессийн нэр",
    dataIndex: "processName",
    key: "processName",
