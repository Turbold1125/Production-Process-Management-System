...
public class FactoryProcessService {
    ...
    public FactoryProcess getProcessById(Long id) throws ServiceException {
    ...
    public void deleteProcess(Long id) throws ServiceException {
    ...
    public FactoryProcess updateProcess(Long id, FactoryProcess factoryProcess) throws ServiceException {
