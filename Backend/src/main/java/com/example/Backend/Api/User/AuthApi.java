...
public interface AuthApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "401", content = {
                    @Content(schema = @Schema(implementation = ServiceException.class)) }),
            @ApiResponse(responseCode = "404") })
    AuthResponse login(@RequestBody AuthenticationRequest request) throws ServiceException;
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "401", content = {
                    @Content(schema = @Schema(implementation = ServiceException.class)) }),
            @ApiResponse(responseCode = "404") })
    void delete(@RequestParam(required = true) Long id) throws ServiceException;
}
